...
def minimal_two_state_activation(kd = 100, kf=1e-3, kfa=1e-1, kra=1):
    # L + R_I <--> LR_I ; kd, kf
    # LR_I <--> LR_A ; kfa, kra
    Parameter('Kd_LR', kd)
    Parameter('kf_L_bind_R', kf)
...
def full_two_state_activation(kd_i=100, kf_i=1e-3,
                                    kd_a=200, kf_a=1e-4
                                    kfa=1e-1, kra=1,
                                    kfia=1e-1, kria=0.1):

    # L + R_I <--> LR_I ; kd_i, kf_i
    # L + R_A <--> LR_A ; kd_a, kf_a
    # LR_I <--> LR_A ; kfa, kra
    # R_I <--> R_A ; kfia, kria
